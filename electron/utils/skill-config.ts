...
interface PreinstalledMarker {
    source: 'investclaw-preinstalled';
    slug: string;
    version: string;
    installedAt: string;
}
...
/**
 * Built-in skills bundled with InvestClaw that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.investclaw-preinstalled.json';
