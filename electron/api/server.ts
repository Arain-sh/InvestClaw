...
import { handleMarketAppRoutes } from './routes/market-apps';
...
export function startHostApiServer(ctx: HostApiContext, port = getPort('INVESTCLAW_HOST_API')): Server {
