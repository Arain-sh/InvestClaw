...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'kimi-code', name: 'Kimi Code', icon: '🌙', placeholder: 'sk-kimi-...', model: 'Kimi', requiresApiKey: true, defaultBaseUrl: 'https://api.kimi.com/coding', defaultModelId: 'kimi-k2.5', docsUrl: 'https://www.kimi.com/code/docs/' },
  ...
  { id: 'ollama', name: 'Ollama', icon: '🦙', placeholder: 'Not required', requiresApiKey: false, defaultBaseUrl: 'http://localhost:11434/v1', showBaseUrl: true, showModelId: true, modelIdPlaceholder: 'qwen3:latest' },
  {
    ...
    docsUrl: 'https://github.com/Arain-sh/InvestClaw#readme',
    docsUrlZh: 'https://github.com/Arain-sh/InvestClaw#readme',
  },
];
