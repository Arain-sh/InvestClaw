...
const GATEWAY_WS_DIAG_FLAG = 'investclaw:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('investclaw:api-log') === '1';
  } catch {
