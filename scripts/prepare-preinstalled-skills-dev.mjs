...
if (process.env.INVESTCLAW_SKIP_PREINSTALLED_SKILLS_PREPARE === '1' || process.env.CLAWX_SKIP_PREINSTALLED_SKILLS_PREPARE === '1') {
  echo`Skipping preinstalled skills prepare (INVESTCLAW_SKIP_PREINSTALLED_SKILLS_PREPARE=1).`;
  process.exit(0);
}
